...
function accordeon() {
  var itemHead = document.querySelectorAll(".stages__item_head");
  var itemHead2 = document.querySelectorAll(".answers__item_head");
...
function catalogPage() {
  var cards = document.querySelectorAll(".catalog__wrapper__item");
...
/* harmony export */ });
function logout() {
  var logbtn = document.querySelector(".logout__wrapper__form_login");
  var modalLog = document.querySelector(".logout__wrapper__login");
  var regBtn = document.querySelector(".logout__wrapper__login_login");
  var modalReg = document.querySelector(".logout__wrapper__form");
...
/* harmony export */ });
function menu() {
  var hamburger = document.querySelector(".header__wrapper__attribute_hamburger");
  var menu = document.querySelector('.menu');
  var closeHamburger = document.querySelector(".menu__block__header_close");
...
function replaseImg() {
  var img = document.querySelector("img.main__wrapper__image_photo");
  var arr = ['./img/mainPage-components/slide/one.jpg', './img/mainPage-components/slide/two.jpg', './img/mainPage-components/slide/three.png'];
  var indificator = 0;
  setInterval(function () {
    if (indificator < arr.length) {
      img.setAttribute('src', "".concat(arr[indificator]));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (replaseImg);
...
function slider() {
  var offerSlider = document.querySelectorAll('.slide__item'),
    // Секция слайд
    slider = document.querySelector('.offer__slider'),
    prev = document.querySelector('.slider__counter__previos'),
    // Cтрелка влево
    next = document.querySelector('.slider__counter__next'),
    // стрелка вправо
  ...
  offerSlider.forEach(function (item) {
    return item.style.width = width;
  });
  slider.style.position = 'relative';
  function slideClean(str) {
    return +str.replace(/\D/g, '');
  }
  function translateWidth(styleWidth) {
    return styleWidth.style.transform = "translateX(-".concat(offset, "px)");
  }
...
function tabs() {
  var tabsHeader = document.querySelectorAll('.specification__wrapper__slider_tabs-img');
  var contentTabs = document.querySelectorAll('.specification__wrapper__slider_main');
  var contentParentTabs = document.querySelector('.specification__wrapper__slider_tabs');
  ...
  contentParentTabs.addEventListener('click', function (event) {
...
/* harmony import */ var _modules_slide_image__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/slide-image */ "./src/js/modules/slide-image.js");
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/tabs */ "./src/js/modules/tabs.js");
/* harmony import */ var _modules_accordeon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/accordeon */ "./src/js/modules/accordeon.js");
/* harmony import */ var _modules_logout__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/logout */ "./src/js/modules/logout.js");
/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/modal */ "./src/js/modules/modal.js");
/* harmony import */ var _modules_catalog__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/catalog */ "./src/js/modules/catalog.js");
...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  (0,_modules_slide_image__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_modules_accordeon__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_modules_logout__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_modules_catalog__WEBPACK_IMPORTED_MODULE_6__["default"])();
